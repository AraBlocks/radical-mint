...
contract Radicals is ERC721Enumerable, Ownable {
    uint256 private basePrice = 10000000000000000; // 0.01 ETH has 18-2=16 0s
    ...
    constructor(string memory baseURI) ERC721("Radicals", "RADS") {
        setBaseURI(baseURI);
    }
